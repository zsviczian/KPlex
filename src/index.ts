...
import { DEFAULT_SETTINGS, KPlexSettings, KPlexSettingTab } from "./Settings";
import { KPlexView } from "./KPlexView";
import { IPeriodicNoteSettings } from "./utils/datehelpers";
import { Pages } from "./graph/Pages";
import { Literal } from "obsidian-dataview";

export default class KPlex extends Plugin {
  private view: KPlexView;
  public settings:KPlexSettings;
  ...
  async onload(): Promise<void> {
    this.registerView(
      VIEW_TYPE,
      (leaf: WorkspaceLeaf) => (this.view = new KPlexView(leaf))
    );
