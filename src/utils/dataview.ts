...
const readDVField = (plugin: KPlex, field: any, file:TFile):string[] => {
  const res = new Set<string>();
...
export const getDVFieldLinksForPage = (plugin: KPlex, dvPage: Record<string, Literal>, fields: string[]):{link:string,field:string}[] => {
